    ...
    <div class="container">
        <div class="d-flex flex-center">
            ...
            <%
                ...
                try{
                    String selectQuery = "SELECT * FROM place WHERE name LIKE ?";
                    PreparedStatement getAllDataStatement = connection.prepareStatement(countQuery);
                    getAllDataStatement.setString(1, "%"+ placeName + "%"); //isi string munculin data
                    ResultSet rs = getAllDataStatement.executeQuery();
                    while(rs.next){
                        //munculin data stringnya mau gimana
                       
                    }

                    String countQuery = "SELECT count(id) AS 'data' FROM place";
